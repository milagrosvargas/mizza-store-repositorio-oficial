<?php
// mizzastore/models/MetodoPago.php
...
class MetodoPago
{
    ...
    private const TABLE  = 'metodo_pago';
    private const ID_COL = 'id_metodo_pago';
    private const NAME   = 'nombre_metodo_pago';
    ...
    {
        $sql = "SELECT " . self::ID_COL . " AS id_metodo_pago,
                       " . self::NAME   . " AS nombre_metodo_pago
                FROM " . self::TABLE . "
